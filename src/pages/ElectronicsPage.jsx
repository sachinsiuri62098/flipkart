...
function Electronics() {
    const Electronics = ProductList.filter((curElem) => {
        return curElem.category === 'electronics'
    })
    // Get all brands in mobiles and tablets in array
    const brands = Electronics.map((values) => { return values.brand })
        ...
        <Layout childern={
            <div className='md:p-4 2xl:px-0 2xl:container 2xl:mx-auto' >
                <div className='w-full bg-white shadow py-3'>
                    <h1 className='text-center text-2xl py-5 font-semibold text-slate-950'>Top Electronic's Deals</h1>
